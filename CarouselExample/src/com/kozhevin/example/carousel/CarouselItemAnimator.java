 ...
 * RecyclerView. RecyclerView uses a DefaultItemAnimator by default.
 *
 * @see RecyclerView#setItemAnimator(RecyclerView.ItemAnimator)
 */
public class CarouselItemAnimator extends RecyclerView.ItemAnimator {
	...
	public void runPendingAnimations() {
		...
		if (additionsPending) {
			...
			if (removalsPending || movesPending) {
				...
				ViewCompat.postOnAnimationDelayed(view, adder, (removalsPending ? getRemoveDuration() : 0)
	...
	public boolean isRunning() {
		return (!mMoveAnimations.isEmpty() || !mRemoveAnimations.isEmpty() || !mAddAnimations.isEmpty()
				|| !mMoves.isEmpty() || !mAdditions.isEmpty());
	}
